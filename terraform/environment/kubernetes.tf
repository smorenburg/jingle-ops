...
# Assign the 'AcrPull' role to the Kubernetes cluster managed identity for the container registry.
...
# Assign the 'Managed Identity Operator' role to the Kubernetes cluster managed identity.
